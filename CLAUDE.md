...
CP_RAG/
  ...
  static/index.html # chat UI + F2 live-context strip (top of page, incl. WIDB chip/card) + Phase 5 PDF upload bar
  context/          # live SG population-context layer (Phase 0–3; stdlib-only, key-free; widb.py also uses pypdf)
